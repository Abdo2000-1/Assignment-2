...
void MainComponent::setFile(juce::File m_file) { file = m_file; }
juce::File MainComponent::getFile() { return file; }
PlayerAudio& MainComponent::getPlayerAudio() { return player; }
PlayerGUI* MainComponent::getPlayerGUI() { return &gui; }
...
juce::String MainComponent::createFileId() {
    auto combined = sha256First5KB()
